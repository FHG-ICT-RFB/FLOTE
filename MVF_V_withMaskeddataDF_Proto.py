import numpy as np
from datafile_V_FINAL import SVF
import datafile_V_FINAL
import Arrays
...
def MVF(Var1,min1,max1,steps1,scale1,Var2,min2,max2,steps2,scale2):
    ...
    for i in array1 :
        ...
        for j in array2 :
            ...
            if datafile_V_FINAL.eG16 < 0 or datafile_V_FINAL.pH10 < 0 :
                Output[x][y] = None
    ...
    df.columns = array2
    df.index = array1
    df.to_excel(excel_writer = "D:/ACADEMICS/MS THESIS/Publication/SCALED DOWN/SENSITIVITY - Scaled Down/SENSITIVITY - Raw Data/V_Conc_CD_New.xlsx")
